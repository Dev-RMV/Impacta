...
namespace ProjetoDeConsultas.Controllers
{
    public class ExameController : Controller
    {
        ...
        public ExameController(ProjetoDeConsultasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Exame != null ? 
                          ...
                          Problem("Entity set 'ProjetoDeConsultasContext.Exame'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("ExameId,NomeExame,Descricao")] Exame exame)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ExameId,NomeExame,Descricao")] Exame exame)
        {
            if (id != exame.ExameId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProjetoDeConsultasContext.Exame'  is null.");
            }
            var exame = await _context.Exame.FindAsync(id);
            if (exame != null)
            {
