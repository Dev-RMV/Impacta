...
namespace ProjetoDeConsultas.Controllers
{
    public class HorarioController : Controller
    {
        ...
        public HorarioController(ProjetoDeConsultasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Horario != null ? 
                          ...
                          Problem("Entity set 'ProjetoDeConsultasContext.Horario'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProjetoDeConsultasContext.Horario'  is null.");
            }
            var horario = await _context.Horario.FindAsync(id);
            if (horario != null)
            {
