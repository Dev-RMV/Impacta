...
namespace Aula13_UmParaMuitos.Controllers
{
    public class StudentController : Controller
    {
        private readonly Aula13_UmParaMuitosContext _context;

        public StudentController(Aula13_UmParaMuitosContext context)
        {
            _context = context;
        }
